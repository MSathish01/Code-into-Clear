...
import { UploadCloud, Code, Loader2, Sparkles, FileText, Github, Search, ArrowRight, Check } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col font-sans relative overflow-hidden bg-slate-50">
      ...
      <header className="relative z-10 border-b border-transparent">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <a href="#" className="hidden sm:flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-brand-700 transition-colors">
            <span className="bg-brand-100/50 text-brand-800 px-3 py-1 rounded-full border border-brand-200/60">v1.0.0</span>
          </a>
        </div>
      </header>
